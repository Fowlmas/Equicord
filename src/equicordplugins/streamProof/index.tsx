...
function EyeIcon({ height = 20, width = 20 }: IconProps) {
    return (
        <svg
            aria-hidden="true"
            role="img"
...
function EyeSlashIcon({ height = 20, width = 20 }: IconProps) {
    return (
        <svg
            aria-hidden="true"
            role="img"
...
export default definePlugin({
    name: "StreamProof",
    description: "Hides messages, links and images while streaming your screen, without hiding the voice/screen share grid. Toggle via a chat bar button.",
